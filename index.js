...
app.post('/create_order', (req, res) => {
    get_access_token()
        .then(access_token => {
           ...
           //console.log('reg.body.intent = ', req.body.intent);
           //console.log('reg.body.purchase_units.currency_code = ', req.body.purchase_units[0].amount.currency_code);
           //console.log('reg.body.purchase_units.amount = ', req.body.purchase_units[0].amount.value);
            let order_data_json = {
    ...
    get_access_token()
        .then(access_token => {
            fetch(endpoint_url + '/v2/checkout/orders/' + req.body.order_id + '/' + req.body.intent, {
                ...
                .then(res => res.json())
                .then(json => {
                    console.log('Complete order: ',json);
                    res.send(json);
                }) //Send minimal data to client
        })
        .catch(err => {
...
//Servers the myfunctions.js file
app.get('/myfunctions.js', (req, res) => {
    res.sendFile(process.cwd() + '/myfunctions.js');
});
